...
app.config['MAIL_USERNAME'] = 'paulholm1110101@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'htnszupvzzssqxwx'  # Your Gmail password or App Password
