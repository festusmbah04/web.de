...
app.config['MAIL_USERNAME'] = 'gen.davidrodriguez09@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'vdxhkzjxeiobmxdl'  # Your Gmail password or App Password
